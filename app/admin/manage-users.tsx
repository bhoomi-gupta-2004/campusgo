...
export default function ManageUsers() {
  ...
  const handleCreateUserWithAuth = async () => {
    ...
    try {
      ...
      // ✅ 2. IF DRIVER → ALSO CREATE DRIVER DOC
      if (role === "Driver") {
        const driverData = {
          uid,
          name,
          phone: "", // you can add input later
          busNumber: busNumber || "",
          role: "Driver",
          routeId: "", // optional (can update later)
          lastKnownLat: null, // ✅ initially null
          lastKnownLng: null, // ✅ initially null
      ...
      Alert.alert("Provisioned", `${name} added successfully`);
          ...
          >
            ...
            <View style={styles.cardFooter}>
              <View style={styles.busInfo}>
                ...
                <Text style={[styles.busText, { color: theme.icon }]}>
                  Route: {item.busNumber || "None"}
                </Text>
              </View>
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
              {!selectedUser && (
                <>
                  ...
                  <TextInput
                    placeholder="university-id@gna.edu"
                    placeholderTextColor={theme.icon}
                    value={email}
              ...
              >
                {submitting ? (
                  ...
                  <Text style={styles.saveText}>
                    {selectedUser ? "Update Member" : "Provision Account"}
                  </Text>
                )}
              </TouchableOpacity>
            </ScrollView>
